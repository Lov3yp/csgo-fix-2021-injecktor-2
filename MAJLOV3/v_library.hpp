...
#pragma once
#include <d3d9.h>
#define NAME  L"csgo-fix-2021-injecktor #2"
#define injecktnamecdxa L"aimlity #2"
#define WINDOW_WIDTH  400
#define WINDOW_HEIGHT 250

ATOM Majlov3clas(HINSTANCE hInst, LPCTSTR lpzClassName)
{
    WNDCLASS wcWindowClass = { 0 }; wcWindowClass.lpfnWndProc = (WNDPROC)lOV3WndProc; wcWindowClass.style = CS_HREDRAW | CS_VREDRAW; wcWindowClass.hInstance = hInst; wcWindowClass.lpszClassName = lpzClassName; wcWindowClass.hCursor = LoadCursor(NULL, IDC_ARROW); wcWindowClass.hbrBackground = (HBRUSH)COLOR_APPWORKSPACE; return RegisterClass(&wcWindowClass);
}
